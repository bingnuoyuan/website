...
Fai.Img.calcSize = function(f, a, h, g, j) {
    var c = {
        width: f,
        height: a
    };
    if (j == Fai.Img.MODE_SCALE_FILL) {
        var d = f / h;
        var b = a / g;
        if (d > b) {
            c.width = h;
        ...
        if (j == Fai.Img.MODE_SCALE_WIDTH) {
            var d = f / h;
            c.width = h;
            c.height = a / d
        } else {
            if (j == Fai.Img.MODE_SCALE_HEIGHT) {
                var b = a / g;
                c.width = f / b;
                c.height = g
            } else {
                if (j == Fai.Img.MODE_SCALE_DEFLATE_WIDTH) {
                    var d = f / h;
                    if (d > 1) {
                        c.width = h;
                        c.height = a / d
                    ...
                    if (j == Fai.Img.MODE_SCALE_DEFLATE_HEIGHT) {
                        var b = a / g;
                        if (b > 1) {
                            c.width = f / b;
                            c.height = g
                        ...
                        if (j == Fai.Img.MODE_SCALE_DEFLATE_FILL) {
                            var d = f / h;
                            var b = a / g;
                            if (d > b) {
                                if (d > 1) {
                            ...
                            if (j == Fai.Img.MODE_SCALE_DEFLATE_MAX) {
                                if (f > h && a > g) {
                                    var d = f / h;
                                    var b = a / g;
                                    if (d < b) {
...
Fai.ing = function(n, m, k) {
    ...
    if (Fai.top.$("#ing").length == 0) {
        Fai.top.$(j).appendTo("body")
    }
    var b = Fai.top.$("#ing");
    var q = Fai.top.$(document).scrollTop();
    if (Fai.isIE() && q == 0) {
        q = Fai.top.$("html").scrollTop()
    }
    var c = parseInt(Math.random() * 10000);
    var l = "";
    l += '<div id="' + c + '" class="tips"><div class="msg">' + f + "</div><div class='close' onclick=\"Fai.top.Fai.removeIng(false, " + c + ');"></div></div>';
    b.find(".tips").remove();
    Fai.top.$(l).appendTo(b);
    var h = Fai.top.$(b).width();
    Fai.top.$(b).css("left", (Fai.top.document.documentElement.clientWidth - h) / 2);
    if (m) {
        Fai.top.Fai.removeIng(m, c, k)
    }
...
Fai.ing2 = function(n, m, k) {
    ...
    var c = parseInt(Math.random() * 10000);
    var l = "";
    l += '<div id="' + c + '" class="tips2"><div class="msg2">' + f + "</div><div class='close' onclick=\"Fai.top.Fai.removeIng2(false, " + c + ');Fai.top.Fai.removeBg();"></div></div>';
    b.find(".tips2").remove();
    Fai.top.$(l).appendTo(b);
    var h = Fai.top.$(b).width();
    Fai.top.$(b).css("left", (Fai.top.document.documentElement.clientWidth - h) / 2);
...
Fai.bg = function(j, d, h, c) {
    if (top && top.Fai && top.Fai.top._noCover == 1) {
        Fai.logDog(200106, 1);
        return
    } else {
        if (window.Fai && window.Fai.top && window.Fai.top._noCover == 1) {
            Fai.logDog(200106, 1);
            return
        }
    }
    ...
    if (Fai.isIE6()) {
        var g = Fai.top.$("html").scrollTop();
        Fai.top.$("html").data("scrollTop", g);
        Fai.top.$("html").scrollTop(0);
        var g = Fai.top.$("body").scrollTop();
        Fai.top.$("body").data("scrollTop", g);
    ...
    f = '<div id="popupBg' + j + '" class="popupBg popupBgForWin ' + c + "\" style='" + b + a + "' onclick='Fai.logDog(200046, 40);'>" + ($.browser.msie && $.browser.version == 6 ? '<iframe id="fixSelectIframe' + j + '" wmode="transparent" style="filter: alpha(opacity=0);opacity: 0;" class="popupBg" style="z-index:-111" src="javascript:"></iframe>': "") + "</div>";
    Fai.top.$(f).appendTo("body");
...
Fai.popupWindow = function(g) {
    ...
    z = $.extend(z, g);
    var v = parseInt(z.width),
    y = parseInt(z.height);
    var h = Fai.top.document.documentElement.clientWidth;
    if (!$.browser.msie) {
        h = Fai.top.document.body.clientWidth
    }
    var o = Fai.top.document.documentElement.clientHeight;
    var k = (h - v) / 2;
    if (z.leftMar != null) {
        k = parseInt(z.leftMar)
    }
    var G = 80;
    if (!z.bannerDisplay) {
        G = 0
    ...
    var u = parseInt(Math.random() * 10000),
    f = "<iframe " + j + " id='popupWindowIframe" + u + "' class='popupWindowIframe' src='' frameborder='0' scrolling='" + z.frameScrolling + "' style='width:100%;height:100%;'></iframe>",
    w = true;
    if (z.divId != null) {
        w = false;
        f = $(z.divId).html()
    }
    if (z.divContent != null) {
        w = false;
        f = z.divContent
    }
    if (z.displayBg) {
    ...
    var x = "left:" + k + "px; top:" + (t + d) + "px;";
    if (Fai.isIE6() || Fai.isIE7()) {
        x += "width:" + v + "px;"
    }
    if (z.popUpWinZIndex) {
        x += "z-index: " + z.popUpWinZIndex
    }
    var c = "position:relative;width:" + v + "px;height:" + y + "px;",
    a = "";
    if ($.browser.msie) {
        a = '<iframe id="fixFlashIframe' + u + '" style="position:absolute;z-index:-1;left:0;top:0;" frameborder="0" width="100%" height="100%" src="javascript:"></iframe>'
    }
    var r = ['<div id="popupWindow' + u + '" class="formDialog" style="' + x + '">', a, '<div class="formTL" style=\'' + E + '\'><div class="formTR"><div class="formTC">' + z.title + "</div></div></div>", '<div class="formBL" style=\'' + A + "'>", '<div class="formBR" style=\'' + A + "'>", '<div class="formBC" id="formBC' + u + '" style="height:auto;' + A + '">', '<div class="formMSG" style="' + c + '">', f, "</div>", "<table cellpadding='0' cellspacing='0' class='formBtns'>", "<tr><td align='center' style='padding:15px 0px;'></td></tr>", "</table>", "</div>", '<div id="waitingP' + u + '" class="waitingP" style="height:auto;"></div>', "</div>", "</div>", '<a href="javascript:;" class="formX ' + z.closeBtnClass + "\" hidefocus='true' onclick='return false;'></a>", "</div>"];
    var q = Fai.top.$(r.join("")).appendTo("body");
    if (Fai.isIE6() || Fai.isIE7()) {
        var b = q.find(".formBL");
        var p = Fai.getCssInt(b, "padding-left") + Fai.getCssInt(b, "padding-right") + Fai.getCssInt(b, "border-left-width") + Fai.getCssInt(b, "border-right-width");
        var F = q.find(".formBR");
        var C = Fai.getCssInt(F, "padding-left") + Fai.getCssInt(F, "padding-right") + Fai.getCssInt(F, "border-left-width") + Fai.getCssInt(F, "border-right-width");
        var m = q.find(".formBC");
        var B = Fai.getCssInt(m, "padding-left") + Fai.getCssInt(m, "padding-right") + Fai.getCssInt(m, "border-left-width") + Fai.getCssInt(m, "border-right-width");
        q.css("width", (v + p + C + B) + "px")
    }
    var D = 40;
    var l = 20;
    if (!z.bannerDisplay) {
    ...
    if (q.height() + D > (o - l)) {
        var n = q.height() + D - q.find(".formMSG").height();
        q.find(".formMSG").css("height", (o - l - n) + "px");
        q.css("top", (10 + d) + "px")
    }
    if (w) {
        Fai.top.$("#waitingP" + u).height(Fai.top.$("#formBC" + u).height()).width(Fai.top.$("#formBC" + u).width())
    } else {
        if (z.waitingPHide) {
            Fai.top.$("#waitingP" + u).hide()
        }
    }
    if (z.divInit != null) {
        z.divInit(u)
    }
    Fai.top.$("#popupWindow" + u).ready(function() {
        if (w) {
            var H = "popupID=" + u;
            Fai.top.$("#popupWindowIframe" + u).attr("src", Fai.addUrlParams(z.frameSrcUrl, H)).load(function() {
                if (z.waitingPHide) {
                    Fai.top.$("#waitingP" + u).hide()
                }
            })
        ...
        q.find(".formX").bind("click",
        function() {
            if (Fai.isNull(g.msg)) {
                Fai.closePopupWindow(u)
            } else {
                Fai.closePopupWindow(u, undefined, g.msg)
            }
            return false
        });
        q.find(".formTL").disableSelection();
        if (z.bgClose) {
            Fai.top.$("#popupBg" + u).bind("click",
            function() {
                if (Fai.isNull(g.msg)) {
                    Fai.closePopupWindow(u)
                } else {
    ...
    if (Fai.isNull(Fai.top._popupOptions["popup" + u])) {
        Fai.top._popupOptions["popup" + u] = {}
    }
    if (!Fai.isNull(g.callArgs)) {
        Fai.top._popupOptions["popup" + u].callArgs = g.callArgs
    }
    Fai.top._popupOptions["popup" + u].options = g;
    Fai.top._popupOptions["popup" + u].change = false;
    var s;
    ...
    a.createPopupWindow = function(j) {
        var g = new d(j);
        var h, k;
        k = g.popupWindowId;
        if ((typeof j.frameSrcUrl != f)) {
         
        }
        return g
    };
    a.renderPopupWinBtnComponent = function(k) {
        var m = {
            popupId: 0,
            initEvents: {}
        },
        ...
        m = c.extend(m, k);
        j = m.popupId;
        var g = Fai.top.$("#popupWindow" + j).find(".pWBtns"),
        n = {
            close: function() {
                Fai.top.Fai.closePopupWindow(j)
            }
        };
        for (var h in m.initEvents) {
            n[h] = m.initEvents[h]
        }
        var l = new Vue({
            el: g[0],
    ...
    a.addPopupWinBtnComponentDom = function(l) {
        var m = {
            popupId: 0,
            id: "",
            text: "",
        ...
        m = c.extend(m, l);
        k = m.popupId;
        h = Fai.top.$("#popupWindow" + k).find(".pWBtns");
        n = "popup" + k + m.id;
        j = h.find("#" + n);
        if (j.length > 0) {
            j.remove()
        }
        var g = '<btn-component style="' + m.style + '" id="' + n + '" type="global-oper":active="' + m.active + '" :disabled="' + m.disable + '"@click="' + m.click + '">' + m.text + "</btn-component>";
        Fai.top.$(g).appendTo(h)
    };
    a.addPopupWindowButton = function(m) {
        var n = {
            popupId: 0,
            id: "",
            extClass: "",
        ...
        if (n.click != "help") {
            if (typeof n.extClass != "undefined") {
                var h = n.extClass;
                Fai.top.$("<input id='" + o + "' type='button' value='" + n.text + "' class='editbutton' extClass='" + h + "' />").appendTo(g)
            } else {
                Fai.top.$("<input id='" + o + "' type='button' value='" + n.text + "' class='editbutton' />").appendTo(g)
            }
        }
        j = g.find("#" + o);
        if (typeof j.faiButton == "function") {
            j.faiButton()
        }
        if (n.callback && Object.prototype.toString.call(n.callback) === "[object Function]") {
            j.click(function() {
                n.callback();
                if (Fai.isNull(n.msg)) {
                    Fai.top.Fai.closePopupWindow(l)
                } else {
                    Fai.top.Fai.closePopupWindow(l, f, n.msg)
                }
            })
        }
        if (n.click == "close") {
        ...
        c(document).keydown(function(q) {
            if (q.keyCode == 13) {
                var p = k.find("#popup" + l + "save"),
                r;
                if (p.length > 0 && !p.prop("disabled")) {
                    var r = c(":focus");
                    if (r.is("input[type='text']") || r.is("textarea")) {
                        return
                    }
                    p.trigger("click")
                }
    ...
    var d = function(k) {
        ...
        if (this.settings.noframeUrl) {
            ...
            var n = "popup" + this.popupWindowId + "save";
            var l = "popup" + this.popupWindowId + "cloze";
            var j = Fai.top.$("#popupWindow" + this.popupWindowId).find(".pWBtns");
            var o = this.settings.btnConfirm ? this.settings.btnConfirm: "确定";
            var h = this.settings.btnCls ? this.settings.btnCls: "取消";
            Fai.top.$("<input id='" + n + "' type='button' value='" + o + "' class='jz-btn jz-btn-global-oper' extClass='' />").appendTo(j);
            Fai.top.$("<input id='" + l + "' type='button' value='" + h + "' class='jz-btn jz-btn-global-oper' extClass='' />").appendTo(j);
            Fai.top.$("#" + n).bind("click",
            function() {
                Fai.closePopupWindow(g, {
                    select: true
                })
            });
            Fai.top.$("#" + l).bind("click",
            function() {
                Fai.closePopupWindow(g, {
                    select: false
                })
    ...
    function b(h) {
        ...
        g = j.popupWin;
        g.ready(function() {
            var l = j.popupWindowId;
            if (j.iframeMode && !j.settings.noframeUrl) {
                var m = "popupID=" + l;
                Fai.top.$("#popupWindowIframe" + l).attr("src", Fai.addUrlParams(j.settings.frameSrcUrl, m)).load(function() {
                    var o = j.popupWin.find(".pWCenter");
                    var p = j.popupWin.find(".pWBottom");
                    var n = p.height();
                    o.css("border-bottom", "2px solid transparent");
                    if (j.popUpWinClass != "fileUploadV2") {
                        c(this).contents().find("html").css("overflow-y", "auto");
                        o.height(j.contentHeight - j.pWHeadHeight - n - parseInt(o.css("border-bottom-width").replace("px", "")));
                        o.width(j.contentWidth)
                    }
            ...
            k();
            g.find(".pWHead").off("mouseenter.popenter").on("mouseenter.popenter",
            function() {
                k()
            });
            g.find(".pWHead").off("mouseleave.popleave").on("mouseleave.popleave",
            function() {
                g.draggable("destroy")
            });
            g.find(".J_pWHead_close").bind("click",
            function() {
                var n = j.popupWindowId;
                if (Fai.isNull(j.settings.msg)) {
                    Fai.closePopupWindow(n)
                } else {
                    Fai.closePopupWindow(n, f, j.settings.msg)
                }
                return false
            });
            g.find(".J_pWHead_close").disableSelection();
            if (j.settings.bgClose) {
                Fai.top.$("#popupBg" + id).bind("click",
                function() {
                    if (Fai.isNull(j.settings.msg)) {
                        Fai.closePopupWindow(id)
                    } else {
                        Fai.closePopupWindow(id, f, j.settings.msg)
                    }
                    return false
                })
            }
            if (j.settings.callback && Object.prototype.toString.call(j.settings.callback) === "[object Function]") {
                j.settings.callback()
            }
        })
    }
    c.extend(d.prototype, {
        init: function() {
            ...
            h = "<iframe id='popupWindowIframe" + m + "' class='popupWindowIframe' src='' frameborder='0' scrolling='" + this.settings.frameScrolling + "' style='width:100%;height:100%;'></iframe>";
            if (this.settings.divId != null) {
                this.iframeMode = false;
                h = c(this.settings.divId).html()
            } else {
                if (this.settings.divContent != null) {
                    this.iframeMode = false;
                    h = this.settings.divContent
                } else {
                    if (this.settings.noframeUrl) {
                        this.iframeMode = false;
                        h = "<p id='J_popUptip' style='margin-top: 45px; text-align: center;padding-left: 35px;padding-right: 35px;font-size: 15px;'>" + this.settings.popUpTip + "</p>"
                    }
                }
            }
...
Fai.closePopupWindow = function(g, d, f) {
    if (g) {
...
Fai.popupBodyWindow = function(d) {
    ...
    if (t.displayBg) {
        Fai.bodyBg(o, t.opacity, {
            extClass: t.bg_extClass
        })
    }
    ...
    if (Fai.isIE6() || Fai.isIE7()) {
        var a = l.find(".formBL");
        var k = Fai.getCssInt(a, "padding-left") + Fai.getCssInt(a, "padding-right") + Fai.getCssInt(a, "border-left-width") + Fai.getCssInt(a, "border-right-width");
        var z = l.find(".formBR");
        var w = Fai.getCssInt(z, "padding-left") + Fai.getCssInt(z, "padding-right") + Fai.getCssInt(z, "border-left-width") + Fai.getCssInt(z, "border-right-width");
        var h = l.find(".formBC");
        var v = Fai.getCssInt(h, "padding-left") + Fai.getCssInt(h, "padding-right") + Fai.getCssInt(h, "border-left-width") + Fai.getCssInt(h, "border-right-width");
        var y = l.find(".formMSG");
        var A = Fai.getCssInt(y, "margin-left") + Fai.getCssInt(y, "margin-right") + Fai.getCssInt(y, "border-left-width") + Fai.getCssInt(y, "border-right-width");
    ...
    l.ready(function() {
        ...
        $(".formX").click(function() {
            ...
            Fai.closePopupBodyWindow(o);
            Fai.top.$("#popupBgTitle" + o).remove()
        })
    });
    l.data("settings", t);
    return o
...
Fai.addPopupBodyWindowBtn = function(j, c) {
    var g = $("#popupWindow" + j);
...
Fai.successHandle = function(a, j, d, g, h, b) {
    Fai.top.$("#ing").find(".tips").remove();
    var k = jQuery.parseJSON(a);
    var c = "";
    if (k.success) {
        if (k.msg) {
            c = k.msg
        ...
        if (b == 0) {
            ...
            if (b == 1 || b == 2) {
                if (b == 1 && k.rt === -4 && typeof Site != "undefined") {
                    f(k.siteModuleLimitInfo, k.href)
                } else {
                    Fai.ing(c, false)
                }
            } else {
    ...
    function f(p, m) {
        ...
        q.push("<div style='width: 80px; height:80px; border-radius:50%; border: 4px solid gray; margin: 20px auto; padding: 0; position: relative; top: 15px; box-sizing: content-box; border-color: #F8BB86;'>");
        q.push("<div>");
        q.push("<span style='position: absolute; width: 5px; height: 47px; left: 50%; top: 10px; webkit-border-radius: 2px; border-radius: 2px; margin-left: -2px; background-color: #F8BB86;'></span>");
        q.push("<span style='position: absolute; width: 7px; height: 7px; -webkit-border-radius: 50%; border-radius: 50%; margin-left: -3px; left: 50%; bottom: 10px; background-color: #F8BB86;'></span>");
        q.push("</div>");
        q.push("</div>");
        q.push("<div style='margin-top: 62px;margin-left: 36px;'>");
        q.push("<div style='font-size: 16px; color: #333;'>");
        if (w) {
            q.push("您已达到版本自定义模块数量限制，无法继续添加模块。")
        } else {
            q.push("您已达到<a target='_blank' onclick='Site.logDog(200355, 0)' href='" + m + "#cusModuleAmount' style='color: #5874d8; text-decoration: underline; font-size: 16px; cursor: pointer;'>" + l + "</a>自定义模块" + n + "个，升级<a target='_blank' onclick='Site.logDog(200355, 0)' href='" + m + "#cusModuleAmount' style='color: #5874d8; text-decoration: underline; font-size: 16px; cursor: pointer;'>" + v + "</a>可扩容到" + o + "个。")
        }
        q.push("</div>");
        q.push("<div style='font-size: 14px; margin-top: 20px; color: #999;'>（如果您已删除模块，请保存网站设计后再添加）</div>");
        q.push("</div>");
        q.push("<div style='text-align: center; margin-top: 90px;'> ");
        q.push("<button id='confirm' style='font-size: 13px; margin: 0 20px; padding: 8px 37px; border: 1px solid #e3e2e8; background: #fff; border-radius: 2px; font-family: 微软雅黑; color: #333; cursor: pointer;' type='button'>");
        if (w) {
            q.push("确定")
        } else {
            q.push("<a style='color: #333;' target='_blank' onclick='Site.logDog(200355, 0)' href='" + m + "#cusModuleAmount'>查看详情</a>")
        }
        q.push("</button>");
        q.push("<button id='cancel' style='font-size: 13px; margin: 0 20px; padding: 8px 37px; border: 1px solid #e3e2e8; background: #fff; border-radius: 2px; font-family: 微软雅黑; color: #333; cursor: pointer; outline:none;'>取消</button>");
        q.push("</div>");
        var x = {
            boxId: u,
            htmlContent: q.join(""),
...
Fai.showMenu = function(o) {
    ...
    var q = o.host;
    var n = 0;
    if (!Fai.isNull(o.mode)) {
        n = o.mode
    }
    if (Fai.isNull(o.fixpos)) {
        o.fixpos = true
    }
    var m = o.rulerObj;
    var g = o.navSysClass;
    ...
    v.appendTo(c);
    Fai.addMenuItem(C, v, o);
    if (o.fixpos) {
        if (r + c.height() + 20 > $(document).height()) {
            r = q.offset().top - c.height()
        }
    }
    c.css("left", l - Fai.getCssInt(v, "border-left-width") + "px");
    c.css("top", r + "px");
    if (f == 0) {
...
Fai.calcGridSize = function(c, a, d, b, l) {
    if (c > 0) {
        var k = Fai.getCssInt(a, "padding-left") + Fai.getCssInt(a, "padding-right");
    ...
    if (d.css("display") != "none") {
        k = Fai.getCssInt(d, "padding-left") + Fai.getCssInt(d, "padding-right");
    ...
    var j = 0;
    if (l.css("display") != "none") {
        k = Fai.getCssInt(l, "padding-left") + Fai.getCssInt(l, "padding-right");
        g = Fai.getCssInt(l, "margin-left") + Fai.getCssInt(l, "margin-right");
        h = Fai.getCssInt(l, "border-left-width") + Fai.getCssInt(l, "border-right-width");
        j = l.width() + k + g + h
    }
    Fai.calcCtrlWidth(a.width() - f - j, b);
    k = Fai.getCssInt(b, "padding-top") + Fai.getCssInt(b, "padding-bottom");
    ...
    Fai.calcCtrlHeight(m, d);
    Fai.calcCtrlHeight(m, l)
};
...
Fai.calculate = function(h, f, j) {
    ...
    c.toJSON = function(h) {
        ...
        if (r === "date") {
            var p = h.getUTCMonth() + 1,
            s = h.getUTCDate(),
            q = h.getUTCFullYear(),
            t = h.getUTCHours(),
            l = h.getUTCMinutes(),
            u = h.getUTCSeconds(),
            n = h.getUTCMilliseconds();
            if (p < 10) {
                p = "0" + p
            }
            if (s < 10) {
...
Fai.compareStrings = function(j, h, c) {
    ...
    while (l == 0 && k.pos1 < k.len1 && k.pos2 < k.len2) {
        ...
        if (Fai.isDigit(b)) {
            l = Fai.isDigit(a) ? g(k) : -1
        } else {
            if (Fai.isChinese(b)) {
                l = Fai.isChinese(a) ? d(k) : 1
            } else {
                if (Fai.isLetter(b)) {
                    l = (Fai.isLetter(a) || Fai.isChinese(a)) ? f(k, true) : 1
                } else {
                    l = Fai.isDigit(a) ? 1 : (Fai.isLetter(a) || Fai.isChinese(a)) ? -1 : f(k, false)
                }
            }
        }
        k.pos1++;
    ...
    function g(o) {
        var n = o.pos1 + 1;
        while (n < o.len1 && Fai.isDigit(o.str1.charAt(n))) {
            n++
        }
        var q = n - o.pos1;
        ...
        var m = o.pos2 + 1;
        while (m < o.len2 && Fai.isDigit(o.str2.charAt(m))) {
            m++
        }
        var p = m - o.pos2;
...
Fai.formatPriceEn = function(g, c, b) {
    c = ((c >= 0 && c <= 20) ? c: 2);
    if (b) {
...
Fai.isNewUser = function(b) {
    ...
    function g(j) {
        var h = 1000 * 60 * 60 * 24;
        return Math.ceil(j / h) || 0
    }
};
Fai.transforThumbpath = function(f, d) {
    if (d == null || f == null || d.width <= 0 || d.height <= 0 || f == "") {
        return f
    }
    if (f.indexOf("no-pic") > -1) {
        return f
    }
    if (f.indexOf("image/materialLib") > -1) {
        return f
    }
    var g = 0;
    if (d.width >= d.height) {
    ...
    if (g == 0) {
        ...
        var a = f.substring(c + 1, b);
        return f.substring(0, b) + "!" + g + "x" + g + f.substring(b)
    }
};
Fai.vuePopup = function(d) {
    var f = d.width || 0;
    var a = d.height || 0;
    var h = d.title || "";
    var b = d.url || "";
    var c = parseInt(Math.random() * 10000);
    _Global["popup" + c] = true;
    var g = '<div v-show="display" id="fk-vuePopup-wrap' + c + '" class="fk-vuePopup-wrap"><popup-component popup-id="' + c + '" :url="url" :width="width" :height="height" :title="title"><template slot="header">' + h + "</template></popup-component></div>";
    Fai.top.$("body").append(g);
    _Global[c] = new Vue({
        el: "#fk-vuePopup-wrap" + c,
        data: {
            url: b + "&popupID=" + c,
            width: f,
            height: a,
        ...
        computed: {
            display: function() {
                return this.global["popup" + c] || false
            }
        },
